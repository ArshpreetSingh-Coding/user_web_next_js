    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                day: "p-0 text-black",
                day_button: cn(
                    "h-7 w-8 text-center text-xs p-0 flex items-center justify-center rounded-md transition-all",
                    "hover:bg-neutral-100 focus:bg-neutral-100 outline-none",
                    "hover:opacity-100 focus:opacity-100",
                    "aria-selected:bg-primary aria-selected:text-white aria-selected:text-white",
                    "aria-selected:hover:bg-primary aria-selected:hover:text-white aria-selected:hover:text-white",
                    "aria-selected:focus:bg-primary aria-selected:focus:text-white aria-selected:focus:text-white",
                    "data-[today]:bg-neutral-100 data-[today]:font-bold data-[today]:text-black data-[today]:opacity-100"
                ),
