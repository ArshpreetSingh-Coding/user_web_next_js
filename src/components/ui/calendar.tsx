    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                day: "p-0",
                day_button: cn(
                    "h-7 w-8 text-center text-xs p-0 flex items-center justify-center rounded-md transition-all hover:bg-neutral-100 focus:bg-neutral-100 outline-none",
                    "aria-selected:bg-primary aria-selected:text-white aria-selected:hover:bg-primary aria-selected:hover:text-white",
                    "data-[today]:bg-neutral-100 data-[today]:font-bold data-[today]:text-primary"
                ),
